// ==UserScript==
// @name         IG The West - Toolkit
// @version      1.55
// @description  Useful tools for The West
// @author       Thathanka Iyothanka (Updated by Igorajs)
...
(function(fn) {
  ...
  TWToolkit = {
    ...
    updateURL: "https://www.west-tools.info/script/files/last_version.txt",
    voteURL: "https://www.jeux-alternatifs.com/The-West-jeu55_hit-parade_1_1.html",
    setsURL: "https://www.west-tools.info/script/files/sets.json",
    chartURL: "https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js",
    langs: {
      base_url: "https://www.west-tools.info/script/Languages/", //Nie działa - Igorajs
      fr_FR: "fr_FR.json",
      en_US: "en_US.json",
      de_DE: "de_DE.json",
      pt_PT: "pt_PT.json",
    ...
    lang:{
        ...
        prefs:{
            ...
            fb_info: "TTTT",
            ids_popup: "TTTT",
            advent_calendar: "TTTT",
            fbanalyzerHtml5: "TTTT",
            owned_forts: "TTTT",
            grouped_telegrams: {
                allys: 'Sojusz',
                towns: 'Miasto',
                extra_players: 'Dodatkowi gracze',
                remove_players: 'Usuń graczy'
            },
            vote: 'TTTT'
        },
        script_lang: 'TTTT',
        create_list: 'Stwórz liste',
        players: 'Gracze',
        send_telegram: 'Wyślij telegram',
        lvl: 'Poziom',
        bestequip_button: 'TTTT',
        bestequip_title: 'TTTT',
        grouped_telegram: 'Telegram grupowy',
        pref: 'Preferencje',
        stop: 'Stop',
        open_info: 'Otwieranie...',
        open_result: 'Wynik',
        open_number: 'Ilość',
        buy_confirm_title: 'Zakup wielu przedmiotów',
        buy_confirm_text1: 'Całkowity koszt: ',
        buy_confirm_text2: 'Jesteś pewny/a, że chcesz kupić x',
        buy_error_location: 'Musisz być w mieście!',
        buy_info: 'Trwa kupowanie...',
        buy_success: 'Kupowanie zakończone powodzeniem.',
        buy_error_money: 'Błąd - Mała ilość pieniędzy',
        buy_number: 'Ilość przedmiotów',
        buy_item_value: 'Cena przedmiotu',
        buy_total_value: 'Całkowita cena zakupu',
        fbpopup_appoint_captain: 'Wyznacz na Kapitana',
        fbpopup_appoint_sergant: 'Wyznacz na Sierżanta',
        fbpopup_appoint_private: 'Wyznacz na Szeregowego',
        fbpopup_appoint_recruit: 'Wyznacz na Rekruta',
        fbpopup_appoint_reservist: 'Wyznacz na Rezerwowego',
        fbpopup_appoint_traitor: 'Wyznacz na Zdrajce',
        fbpopup_error_rank: 'Błąd',
        fbpopup_error_self: 'Błąd',
        fbpopup_player: 'Gracz',
        fbcemetery_head_cri: 'Trafienia krytyczne',
        fbcemetery_head_gho: 'Aktywowane pasywki PP',
        fbinfo_totaldmg: 'Całkowite obrażenia',
        fbinfo_total: 'Razem',
        fbinfo_hit: 'Trafione strzały',
        fbinfo_missed: 'Chybione strzały',
        fbinfo_gotshot: 'Otrzymane strzały',
        fbinfo_dodge: 'Uniknięte strzały',
        calendar: 'Kalendarz',
        bestequip_val: 'TTTT',
        search: 'Szukaj',
        ...
        stats: 'Statystyki',
        graph: 'Wykres',
        openanalyzer: 'Otwórz analize',
        nbplayers: 'Ilość graczy',
        losthp: 'Stracone życie',
        fbinfo_lastdmg: 'Ostatnie obrażenia',
        hpwarning: 'Mała ilość HP!',
        forts: 'Forty',
        fort_size: 'Rozmiar fortu',
        fort_sizes:{
            small: 'Mały',
            medium: 'Średni',
            large: 'Duży'
    ...
    itemUse: {
      itemList: [1975000, 1946000, 1976000, 2675000, 2676000, 2561000, 2562000, 13711000, 2690000, 379000, 50382000, 50839000, 50855000, 51156000, 51324000, 2136000, 2393000, 2137000, 2394000, 2138000, 2395000, 2139000,2559000,51468000,2560000,51810000,51921000,2196000,2197000,2198000,2199000,2200000,21340000,21341000,21342000,21343000,50991000,2491000,51066000,51783000,51835000,52053000,52293000,51776000,2227000,2345000,50605000,52271000],
      ...
      init: function() {
        ...
        ItemUse.use = function(itemId, bonuses, type) {
          ...
          if (TWToolkit.itemUse.itemList.indexOf(itemId) !== -1) {
            ...
            var dialogDiv = $('.system_icon_question + .tw2gui_dialog_text > div');
            dialogDiv.html(dialogDiv.html() + TWToolkit.lang.open_number + '<p><input class="open_popup_input" type="text" id="open_popup_input" value="1" style="width:50px;" />' + '<span class="open_count_scrolls"><img src="images/scrollbar/scroll_up.png" id="open_rise_count" alt="' + 'en haut' + '"><img src="/images/scrollbar/scroll_down.png" id="open_lower_count" alt="' + 'en bas' + '"></span><span class="item_popup_max_count" id="open_max_item">(' + item.count + ') </span>');
    ...
    critHits: {
      init: function() {
        ...
        var inject1 = TWToolkit.prepareInjection(CemeteryWindow.showStatInit.toString(), ["$('div.cemetery-content',"], [0], ["CemeteryWindow.table.addColumn('battle_cri',{sortBy:'crithits'}).addColumn('battle_gho',{sortBy:'playdeadcount'}).appendToThCell('head','battle_cri',TWToolkit.lang.fbcemetery_head_cri,'&nbsp;').appendToThCell('head','battle_gho',TWToolkit.lang.fbcemetery_head_gho,'&nbsp;');sortByObj.sortBy=null;"]);
        ...
        var inject3 = "var sortByObj={sortBy:null,orderBy:'ASC'};" +
    ...
    bestEquip: {
      ...
      getBestEquipment: function() {
        ...
        $.get('https://www.west-tools.info/toolkit/calc.php', {
